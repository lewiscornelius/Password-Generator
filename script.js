...
function getPasswordOptions() {
    var length = parseInt(
        prompt("How many characters would you like your password to have? Please enter a number between 8 and 128."),
        10
    );
    ...
    if (Number.isNaN(length)) {
        ...
        alert("Length must be less than 129 characters")
        return null;
    }
    ...
    if (
        ...
        alert("Your password needs to have at least one character type.");
        return null;
    }
...
function generatePassword() {
    ...
    for (var i = guaranteedCharacters.length; i < options.length; i++) {
        var chosenCharacter = getRandom(possibleCharacters);
